...
export interface ComponentOptions<P extends Record<string, PropDefinition> = any, S = any, G extends GettersFn<InferProps<P>, S> = any, C extends ComputedFn<InferProps<P>, S> = any, A extends ActionsFn<InferProps<P>, S, ReturnType<C>> = any> {
    tagName: string;
    props?: P;
    state?: S;
    getters?: G;
