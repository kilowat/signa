...
export declare function prop<T>(config: Omit<ModelPropDefinition<T>, 'model'>): ModelPropDefinition<T>;
...
interface ComponentOptions<P extends PropsDefinition, S> {
    ...
    connected?: (context: ComponentContext<InferProps<P>, S, GettersFn<InferProps<P>, S>, ComputedFn<InferProps<P>, S>, ActionsFn<InferProps<P>, S, ReturnType<ComputedFn<InferProps<P>, S>>>>) => void;
    render?: (context: ComponentContext<InferProps<P>, S, GettersFn<InferProps<P>, S>, ComputedFn<InferProps<P>, S>, ActionsFn<InferProps<P>, S, ReturnType<ComputedFn<InferProps<P>, S>>>>) => unknown;
    listen?: (params: ListenerParams<InferProps<P>, S, GettersFn<InferProps<P>, S>, ComputedFn<InferProps<P>, S>, ActionsFn<InferProps<P>, S, ReturnType<ComputedFn<InferProps<P>, S>>>>) => void;
    disconnected?: (context: ComponentContext<InferProps<P>, S, GettersFn<InferProps<P>, S>, ComputedFn<InferProps<P>, S>, ActionsFn<InferProps<P>, S, ReturnType<ComputedFn<InferProps<P>, S>>>>) => void;
}
export interface StateSubscriptionCallback<S> {
    newValue: S;
    oldValue: S;
}
export declare function defineComponent<P extends PropsDefinition, S>(options: ComponentOptions<P, S>): {
    new (): {
        props: Signal<InferProps<P>>;
        state: State<S>;
        getters: GettersProperties<ReturnType<GettersFn<InferProps<P>, S>>>;
        computed: ComputedProperties<ReturnType<ComputedFn<InferProps<P>, S>>>;
        actions: ReturnType<ActionsFn<InferProps<P>, S, DefaultRecord>>;
        slots: Record<string, Node[]>;
        cleanup: (() => void)[];
        $<T = any>(key: string): T | undefined;
        ...
        updateProp(name: keyof P, value: PropType): void;
        readonly context: ComponentContext<InferProps<P>, S, GettersFn<InferProps<P>, S>, ComputedFn<InferProps<P>, S>, ActionsFn<InferProps<P>, S, DefaultRecord>>;
        getPropValue(): InferProps<P>;
        setupGetters(): GettersProperties<ReturnType<GettersFn<InferProps<P>, S>>>;
        setupComputed(): ComputedProperties<ReturnType<ComputedFn<InferProps<P>, S>>>;
        setupActions(): ReturnType<ActionsFn<InferProps<P>, S, DefaultRecord>>;
