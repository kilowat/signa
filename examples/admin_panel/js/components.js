...
signa.defComponent("page-view", ({ html }) => {
...
signa.defComponent('home-page', ({ html }) => {
    return html`
        <div class="ui grid">
                    ...
                    <div class="ui centered grid">
                        <div class="row">
                            ...
                            <div class="ten wide computer column">
                                ...
                                7120 Views
                                <a class="ui tiny label simplelable"><i class="eye icon"></i>
                                    Details</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="eight wide computer sixteen wide phone column justifed">
            ...
            <div class="ui tall stacked segment">
                ...
                <div class="ui divider"></div>
                <button id="rand-multi-axis" class="ui blue button simplelable">Randomize
                    Data</button>
            </div>
        </div>
        <div class="eight wide computer sixteen wide phone column justifed">
